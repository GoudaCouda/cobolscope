...
**Source File:** `C:\Users\austi\proleap-cli\tests\fixtures\bank_of_z\cobol\XFRFUN.cbl`  
...
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`HV-ACCOUNT-SORTCODE`<br/><small>`HOST-ACCOUNT-ROW.HV-ACCOUNT-KEY.HV-ACCOUNT-SORTCODE`</small> | Alphanumeric (6 chars) | `X(6)` | 20 | 6 | — | `A010`, `UADF010`, `UADT010` |
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`HV-ACCOUNT-ACC-NO`<br/><small>`HOST-ACCOUNT-ROW.HV-ACCOUNT-KEY.HV-ACCOUNT-ACC-NO`</small> | Alphanumeric (8 chars) | `X(8)` | 26 | 8 | — | `A010`, `UADF010` *(+2 more)* |
...
| 03 | &nbsp;&nbsp;`HV-ACCOUNT-ACTUAL-BAL`<br/><small>`HOST-ACCOUNT-ROW.HV-ACCOUNT-ACTUAL-BAL`</small> | Signed Decimal(12, 2) Packed | `S9(10)V99`<br/>*COMP_3* | 87 | 7 | — | `UADF010`, `UADT010` |
| 01 | **`FILLER`**<br/><small>`FILLER`</small> | Elementary | *DISPLAY* | 94 | 0 | — | — |
| 01 | **`HOST-PROCTRAN-ROW`**<br/><small>`HOST-PROCTRAN-ROW`</small> | Group | *DISPLAY* | 94 | 96 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-EYECATCHER`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-EYECATCHER`</small> | Alphanumeric (4 chars) | `X(4)` | 94 | 4 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-SORT-CODE`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-SORT-CODE`</small> | Alphanumeric (6 chars) | `X(6)` | 98 | 6 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-ACC-NUMBER`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-ACC-NUMBER`</small> | Alphanumeric (8 chars) | `X(8)` | 104 | 8 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-DATE`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-DATE`</small> | Alphanumeric (10 chars) | `X(10)` | 112 | 10 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-TIME`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-TIME`</small> | Alphanumeric (6 chars) | `X(6)` | 122 | 6 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-REF`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-REF`</small> | Alphanumeric (12 chars) | `X(12)` | 128 | 12 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-TYPE`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-TYPE`</small> | Alphanumeric (3 chars) | `X(3)` | 140 | 3 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-DESC`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-DESC`</small> | Alphanumeric (40 chars) | `X(40)` | 143 | 40 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`HV-PROCTRAN-AMOUNT`<br/><small>`HOST-PROCTRAN-ROW.HV-PROCTRAN-AMOUNT`</small> | Signed Decimal(12, 2) Packed | `S9(10)V99`<br/>*COMP_3* | 183 | 7 | — | `WTPD010` |
...
| 05 | &nbsp;&nbsp;`WS-CICS-RESP`<br/><small>`WS-CICS-WORK-AREA.WS-CICS-RESP`</small> | Signed Integer (32-bit Binary) | `S9(8)`<br/>*COMP* | 190 | 4 | — | `UAD010`, `UADT010`, `AH010` |
| 05 | &nbsp;&nbsp;`WS-CICS-RESP2`<br/><small>`WS-CICS-WORK-AREA.WS-CICS-RESP2`</small> | Signed Integer (32-bit Binary) | `S9(8)`<br/>*COMP* | 194 | 4 | — | `UAD010`, `UADT010`, `AH010` |
...
| 03 | &nbsp;&nbsp;`COMM-FACCNO`<br/><small>`DFHCOMMAREA.COMM-FACCNO`</small> | Numeric Display (8 digits) | `9(8)` | 0 | 8 | — | `UAD010`, `UADF010`, `WTPD010` |
| 03 | &nbsp;&nbsp;`COMM-FSCODE`<br/><small>`DFHCOMMAREA.COMM-FSCODE`</small> | Numeric Display (6 digits) | `9(6)` | 8 | 6 | — | `A010`, `UAD010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`COMM-TACCNO`<br/><small>`DFHCOMMAREA.COMM-TACCNO`</small> | Numeric Display (8 digits) | `9(8)` | 14 | 8 | — | `UAD010`, `UADT010`, `WTPD010` |
| 03 | &nbsp;&nbsp;`COMM-TSCODE`<br/><small>`DFHCOMMAREA.COMM-TSCODE`</small> | Numeric Display (6 digits) | `9(6)` | 22 | 6 | — | `A010`, `UAD010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`COMM-AMT`<br/><small>`DFHCOMMAREA.COMM-AMT`</small> | Signed Decimal Display (12, 2) | `S9(10)V99` | 28 | 12 | — | `A010`, `UADF010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`COMM-FAVBAL`<br/><small>`DFHCOMMAREA.COMM-FAVBAL`</small> | Signed Decimal Display (12, 2) | `S9(10)V99` | 40 | 12 | — | `UADF010` |
| 03 | &nbsp;&nbsp;`COMM-FACTBAL`<br/><small>`DFHCOMMAREA.COMM-FACTBAL`</small> | Signed Decimal Display (12, 2) | `S9(10)V99` | 52 | 12 | — | `UADF010` |
| 03 | &nbsp;&nbsp;`COMM-TAVBAL`<br/><small>`DFHCOMMAREA.COMM-TAVBAL`</small> | Signed Decimal Display (12, 2) | `S9(10)V99` | 64 | 12 | — | `UADT010` |
| 03 | &nbsp;&nbsp;`COMM-TACTBAL`<br/><small>`DFHCOMMAREA.COMM-TACTBAL`</small> | Signed Decimal Display (12, 2) | `S9(10)V99` | 76 | 12 | — | `UADT010` |
| 03 | &nbsp;&nbsp;`COMM-FAIL-CODE`<br/><small>`DFHCOMMAREA.COMM-FAIL-CODE`</small> | Alphanumeric (1 chars) | `X` | 88 | 1 | — | `A010`, `UAD010` *(+3 more)* |
| 03 | &nbsp;&nbsp;`COMM-SUCCESS`<br/><small>`DFHCOMMAREA.COMM-SUCCESS`</small> | Alphanumeric (1 chars) | `X` | 89 | 1 | — | `A010`, `UAD010` *(+3 more)* |
...
| 01 | **`DB2-DEADLOCK-RETRY`**<br/><small>`DB2-DEADLOCK-RETRY`</small> | Numeric Display (3 digits) | `999` | 7 | 3 | — | `A010`, `UADT010` |
...
| 01 | **`WS-EIBTASKN12`**<br/><small>`WS-EIBTASKN12`</small> | Numeric Display (12 digits) | `9(12)` | 216 | 12 | **Default:** `0` | `WTPD010` |
| 01 | **`WS-SQLCODE-DISP`**<br/><small>`WS-SQLCODE-DISP`</small> | Numeric Display (9 digits) | `9(9)` | 228 | 9 | **Default:** `0` | `WTPD010` |
| 01 | **`DESIRED-ACC-KEY`**<br/><small>`DESIRED-ACC-KEY`</small> | Group | *DISPLAY* | 237 | 14 | — | — |
| 03 | &nbsp;&nbsp;`DESIRED-SORT-CODE`<br/><small>`DESIRED-ACC-KEY.DESIRED-SORT-CODE`</small> | Numeric Display (6 digits) | `9(6)` | 237 | 6 | — | `A010`, `UAD010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`DESIRED-ACC-NO`<br/><small>`DESIRED-ACC-KEY.DESIRED-ACC-NO`</small> | Numeric Display (8 digits) | `9(8)` | 243 | 8 | — | `UAD010`, `UADF010`, `UADT010` |
...
| 01 | **`WS-U-TIME`**<br/><small>`WS-U-TIME`</small> | Signed Integer(15) Packed | `S9(15)`<br/>*COMP_3* | 303 | 8 | — | `UAD010`, `UADT010` *(+2 more)* |
| 01 | **`WS-ORIG-DATE`**<br/><small>`WS-ORIG-DATE`</small> | Alphanumeric (10 chars) | `X(10)` | 311 | 10 | — | `UAD010`, `UADT010` *(+2 more)* |
...
| 01 | **`WS-ORIG-DATE-GRP-X`**<br/><small>`WS-ORIG-DATE-GRP-X`</small> | Group | *DISPLAY* | 321 | 10 | — | `WTPD010` |
...
| 01 | **`PROCTRAN-AREA`**<br/><small>`PROCTRAN-AREA`</small> | Group | *DISPLAY* | 333 | 99 | — | `WTPD010` |
...
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`PROC-TRAN-TYPE`<br/><small>`PROCTRAN-AREA.PROC-TRAN-DATA.PROC-TRAN-TYPE`</small> | Alphanumeric (3 chars) | `X(3)` | 377 | 3 | • `88 PROC-TY-CHEQUE-ACKNOWLEDGED`: 'CHA'<br/>• `88 PROC-TY-CHEQUE-FAILURE`: 'CHF'<br/>• `88 PROC-TY-CHEQUE-PAID-IN`: 'CHI'<br/>• `88 PROC-TY-CHEQUE-PAID-OUT`: 'CHO'<br/>• `88 PROC-TY-CREDIT`: 'CRE'<br/>• `88 PROC-TY-DEBIT`: 'DEB'<br/>• `88 PROC-TY-WEB-CREATE-ACCOUNT`: 'ICA'<br/>• `88 PROC-TY-WEB-CREATE-CUSTOMER`: 'ICC'<br/>• `88 PROC-TY-WEB-DELETE-ACCOUNT`: 'IDA'<br/>• `88 PROC-TY-WEB-DELETE-CUSTOMER`: 'IDC'<br/>• `88 PROC-TY-BRANCH-CREATE-ACCOUNT`: 'OCA'<br/>• `88 PROC-TY-BRANCH-CREATE-CUSTOMER`: 'OCC'<br/>• `88 PROC-TY-BRANCH-DELETE-ACCOUNT`: 'ODA'<br/>• `88 PROC-TY-BRANCH-DELETE-CUSTOMER`: 'ODC'<br/>• `88 PROC-TY-CREATE-SODD`: 'OCS'<br/>• `88 PROC-TY-PAYMENT-CREDIT`: 'PCR'<br/>• `88 PROC-TY-PAYMENT-DEBIT`: 'PDR'<br/>• `88 PROC-TY-TRANSFER`: 'TFR' | `WTPD010` |
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`PROC-TRAN-DESC`<br/><small>`PROCTRAN-AREA.PROC-TRAN-DATA.PROC-TRAN-DESC`</small> | Alphanumeric (40 chars) | `X(40)` | 380 | 40 | — | `WTPD010` |
...
| 07 | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`PROC-TRAN-DESC-XFR-SORTCODE`<br/><small>`PROCTRAN-AREA.PROC-TRAN-DATA.PROC-TRAN-DESC-XFR.PROC-TRAN-DESC-XFR-SORTCODE`</small> | Numeric Display (6 digits) | `9(6)` | 406 | 6 | — | `WTPD010` |
| 07 | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`PROC-TRAN-DESC-XFR-ACCOUNT`<br/><small>`PROCTRAN-AREA.PROC-TRAN-DATA.PROC-TRAN-DESC-XFR.PROC-TRAN-DESC-XFR-ACCOUNT`</small> | Numeric Display (8 digits) | `9(8)` | 412 | 8 | — | `WTPD010` |
...
| 01 | **`MY-ABEND-CODE`**<br/><small>`MY-ABEND-CODE`</small> | Alphanumeric (4 chars) | `XXXX` | 903 | 4 | — | `AH010` |
| 01 | **`WS-STORM-DRAIN`**<br/><small>`WS-STORM-DRAIN`</small> | Alphanumeric (1 chars) | `X` | 907 | 1 | **Default:** `N` | `AH010` |
| 01 | **`STORM-DRAIN-CONDITION`**<br/><small>`STORM-DRAIN-CONDITION`</small> | Alphanumeric (20 chars) | `X(20)` | 908 | 20 | — | `CFSDD010` |
| 01 | **`SQLCODE-DISPLAY`**<br/><small>`SQLCODE-DISPLAY`</small> | Signed Numeric Display (8 digits) | `S9(8)` | 928 | 8 | — | `UADT010`, `CFSDD010`, `AH010` |
...
| 03 | &nbsp;&nbsp;`WS-TIME-NOW`<br/><small>`WS-TIME-DATA.WS-TIME-NOW`</small> | Numeric Display (6 digits) | `9(6)` | 950 | 6 | — | `WTPD010` |
| 03 | &nbsp;&nbsp;`WS-TIME-NOW-GRP`<br/><small>`WS-TIME-DATA.WS-TIME-NOW-GRP`</small> | Group | *DISPLAY* | 950 | 6 | <mark>REDEFINES WS-TIME-NOW</mark> | — |
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`WS-TIME-NOW-GRP-HH`<br/><small>`WS-TIME-DATA.WS-TIME-NOW-GRP.WS-TIME-NOW-GRP-HH`</small> | Numeric Display (2 digits) | `99` | 950 | 2 | — | `UAD010`, `UADT010` *(+2 more)* |
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`WS-TIME-NOW-GRP-MM`<br/><small>`WS-TIME-DATA.WS-TIME-NOW-GRP.WS-TIME-NOW-GRP-MM`</small> | Numeric Display (2 digits) | `99` | 952 | 2 | — | `UAD010`, `UADT010` *(+2 more)* |
...
| 01 | **`ABNDINFO-REC`**<br/><small>`ABNDINFO-REC`</small> | Group | *DISPLAY* | 964 | 678 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-VSAM-KEY`<br/><small>`ABNDINFO-REC.ABND-VSAM-KEY`</small> | Group | *DISPLAY* | 964 | 12 | — | — |
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`ABND-UTIME-KEY`<br/><small>`ABNDINFO-REC.ABND-VSAM-KEY.ABND-UTIME-KEY`</small> | Signed Integer(15) Packed | `S9(15)`<br/>*COMP_3* | 964 | 8 | — | `UAD010`, `UADT010` *(+2 more)* |
| 05 | &nbsp;&nbsp;&nbsp;&nbsp;`ABND-TASKNO-KEY`<br/><small>`ABNDINFO-REC.ABND-VSAM-KEY.ABND-TASKNO-KEY`</small> | Numeric Display (4 digits) | `9(4)` | 972 | 4 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-APPLID`<br/><small>`ABNDINFO-REC.ABND-APPLID`</small> | Alphanumeric (8 chars) | `X(8)` | 976 | 8 | — | — |
| 03 | &nbsp;&nbsp;`ABND-TRANID`<br/><small>`ABNDINFO-REC.ABND-TRANID`</small> | Alphanumeric (4 chars) | `X(4)` | 984 | 4 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-DATE`<br/><small>`ABNDINFO-REC.ABND-DATE`</small> | Alphanumeric (10 chars) | `X(10)` | 988 | 10 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-TIME`<br/><small>`ABNDINFO-REC.ABND-TIME`</small> | Alphanumeric (8 chars) | `X(8)` | 998 | 8 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-CODE`<br/><small>`ABNDINFO-REC.ABND-CODE`</small> | Alphanumeric (4 chars) | `X(4)` | 1006 | 4 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-PROGRAM`<br/><small>`ABNDINFO-REC.ABND-PROGRAM`</small> | Alphanumeric (8 chars) | `X(8)` | 1010 | 8 | — | — |
| 03 | &nbsp;&nbsp;`ABND-RESPCODE`<br/><small>`ABNDINFO-REC.ABND-RESPCODE`</small> | Signed Numeric Display (8 digits) | `S9(8)` | 1018 | 8 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-RESP2CODE`<br/><small>`ABNDINFO-REC.ABND-RESP2CODE`</small> | Signed Numeric Display (8 digits) | `S9(8)` | 1026 | 8 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-SQLCODE`<br/><small>`ABNDINFO-REC.ABND-SQLCODE`</small> | Signed Numeric Display (8 digits) | `S9(8)` | 1034 | 8 | — | `UAD010`, `UADT010` *(+2 more)* |
| 03 | &nbsp;&nbsp;`ABND-FREEFORM`<br/><small>`ABNDINFO-REC.ABND-FREEFORM`</small> | Alphanumeric (600 chars) | `X(600)` | 1042 | 600 | — | `UAD010`, `UADT010` *(+2 more)* |
